...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["input-output-timer-input-output-timer-module"], {
  ...
  function srcAppInputOutputTimerFormsFormsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FormsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 2,
      consts: [[1, "input-group", "forms"], ["for", "timer"], ["type", "number", "placeholder", "Enter timer limit", "id", "timer", "aria-describedby", "basic-addon1", 1, "form-control", 3, "input"], [1, "buttonStyle"], [1, "btn", "btn-primary", 2, "margin-right", "2rem", 3, "click"], [1, "btn", "btn-info", 3, "click"], ["class", "pauseContent", 4, "ngIf"], [1, "pauseContent"], [4, "ngFor", "ngForOf"]],
  ...
  function srcAppInputOutputTimerInputOutputTimerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    InputOutputTimerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 5,
      consts: [[1, "main"], [1, "row"], [1, "col-md-4", "main_display"], [3, "timerLimit"], [1, "col-md-6", "main_form"], [3, "emitTimerValue", "emitStartCount", "emitPausedCount", "emitStartTime", "emitResetStartLogs"], [1, "col-md-5", "main_logger"], [3, "startTime", "resetStartLog"], [1, "col-md-5", "main_counter"], [3, "startCount", "pausedCount"]],
      template: function InputOutputTimerComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("emitTimerValue", function InputOutputTimerComponent_Template_app_forms_emitTimerValue_8_listener($event) {
            return ctx.setTimerLimit($event);
          })("emitStartCount", function InputOutputTimerComponent_Template_app_forms_emitStartCount_8_listener($event) {
            return ctx.setStartCount($event);
          })("emitPausedCount", function InputOutputTimerComponent_Template_app_forms_emitPausedCount_8_listener($event) {
            return ctx.setPausedCount($event);
          })("emitStartTime", function InputOutputTimerComponent_Template_app_forms_emitStartTime_8_listener($event) {
            return ctx.setStartTime($event);
          })("emitResetStartLogs", function InputOutputTimerComponent_Template_app_forms_emitResetStartLogs_8_listener($event) {
